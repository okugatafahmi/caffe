...
# The database file for training data. Created by data/vehicle_type/create_data.sh
train_data = "examples/vehicle_type/vehicle_type_train_lmdb"
...
# Stores the test image names and sizes. Created by data/vehicle_type/create_list.sh
name_size_file = "data/vehicle_type/test_name_size.txt"
